...
public abstract class UITweener : MonoBehaviour
{
    ...
    protected virtual void OnEnable() { if (style == Style.Once && playOnEnable) { SetEnable(); ResetToBeginning(); } }
	/// <summary>
    ...
    {
        if (style == Style.Once && playOnEnable) _enable = false;
        else enabled = false;
    }
