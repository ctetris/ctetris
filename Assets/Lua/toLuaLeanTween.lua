...
LeanTween.rotateAround(gameObject, Vector3.up, 10, 0.2):setEase( LeanTweenType.easeShake ):setLoopClamp():setRepeat(30)
...
local camera=LuaHelper.Find("Camera")
...
-- --moveSpline
LeanTween.move(camera,paths, 2):setOrientToPath(true):setEase(LeanTweenType.easeInQuart):setDelay(1):setOnComplete(oncomplete):setOnCompleteParam(paths) --setOrientToPath(true):
